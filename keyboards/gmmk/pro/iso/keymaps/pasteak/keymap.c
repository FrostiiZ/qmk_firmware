...
//  92, Side led 08
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RESET,            KC_DEL,
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
	...
	if (IS_HOST_LED_ON(USB_LED_CAPS_LOCK)) {
      ...
      RGB_MATRIX_INDICATOR_SET_COLOR(69, 255, 255, 255); // right-side LEDs
